...
const HomeHero: React.FC<HomeHeroProps> = ({
  ...
  return (
    <div className="relative bg-white pt-24 pb-5 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start">
        <div className="w-full mx-auto lg:w-1/2 text-left mt-32 lg:mb-0 lg:pr-12">
          <h1 className="text-4xl sm:text-5xl md:text-6xl  font-extrabold text-primary leading-tight mb-4">
            <span className="block mb-2">{titleLine1}</span>
            <span className="block ml-20">{titleLine2}</span>
          </h1>
          <p className="mt-3 text-bold  sm:text-lg md:text-xl text-secondary max-w-md">
            {subtitle}
          </p>
        </div>
